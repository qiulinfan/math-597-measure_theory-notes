...
And for each $k \leq n$, $I_k$ is entirely not contained in $(0,r)$ except possibly one point $\frac{1}{n}$, which can be neglected, and it is on the right of $r$.\\
Thus we only need to consider about the 
